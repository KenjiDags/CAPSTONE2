...
<style>
.view-card { background:#fff; padding:20px; margin-bottom:16px; border:1px solid #e5e7eb; border-radius:8px; }
...
<div class="content">
    ...
    <div class="actions" style="margin-bottom:20px;">
        ...
        <a href="export_iirusp.php?iirusp_id=<?= $iirusp_id ?>" class="btn-export" target="_blank"><i class="fas fa-print"></i> Print</a>
    </div>

    <div class="view-card">
        <h3>IIRUSP Information</h3>
        <div class="info-grid">
    ...
    <div class="view-card">
        ...
        <div class="signature-section">
            <div class="signature-box">
                ...
                <div><strong>Requested By (Accountable Officer)</strong></div>
            </div>
            <div class="signature-box">
        ...
        <div class="signature-section">
            <div class="signature-box">
                ...
                <div><strong>Inspection Officer</strong></div>
            </div>
            <div class="signature-box">
